    ...
    if st.button("🚀 開始精準合併並對帳", type="primary"):
        with st.spinner("正在執行對帳座標運算..."):
            try:
                ...
                birth_map = {'李':77,'珩':78,'芳':79,'東':80,'澍':81,'李建南':82,'林慧雯':83,'陳思宇':84}
                room_map = {'李':86,'珩':87,'芳':88,'東':89,'澍':90,'李建南':91,'張明揚':92,'鄭':93,'陳思宇':94,'林慧雯':95}
                nurs_map = {'李':116,'珩':117,'芳':118,'東':119,'澍':120,'李建南':121,'張明揚':122,'林慧雯':123}
